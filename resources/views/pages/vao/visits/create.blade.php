...
@section('content')
        ...
        <div class="col-10 my-auto">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>{{ __('forms.create') . ' ' . __('Visits') }}</strong>
                </li>
            </ol>
        </div>
    ...
    <div class="ibox">
        <div class="ibox-title">
            <h5>{{ __('forms.create') . ' ' . __('Visits') }}</h5>
        ...
        <div class="ibox-content">
            <div class="mx-5">
                <form action="{{ route('vao.store.visits') }}" method="POST">
                    @csrf
                    @method('put')

                    <input type="hidden" name="token" value="{{ $vao->token }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3 @error('starts_at') has-error @enderror">
                            ...
                            <input type="date" name="starts_at" id="starts_at" class="form-control"
                                placeholder="{{ __('forms.starts_at') }}..." value="{{ old('starts_at') }}" />
                        </div>
                        ...
                        <div class="col-lg-6 mb-3 @error('ends_at') has-error @enderror">
                            ...
                            <input type="date" name="ends_at" id="ends_at" class="form-control"
                                placeholder="{{ __('forms.ends_at') }}..." value="{{ old('ends_at') }}" />
                        </div>
