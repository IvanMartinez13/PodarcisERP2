...
class DashboardOds extends React.Component {
                ...
                <div className="row animated fadeInRight mt-4">
                        ...
                        >
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4">
                                    ...
                                    <p
                                        dangerouslySetInnerHTML={{
                                            __html: this.objective.indicator,
                                        }}
                                    ></p>
                                </div>
                    ...
                    <div className="col-lg-7 mb-lg-0 mb-5 order-1">
                        <div
                            ...
                            style={{ height: "100%" }}
                        >
                            <h5 className="mb-3 text-center">Estrategias</h5>

                            <div className="row">
                                {this.strategies.map((strategy, index) => {
                                    return (
                                        <div
                                            key={strategy.token + index}
    ...
    componentDidUpdate() {
        if (this.state.update == true) {
            axios
                .post("/ods/dashboard", { token: this.objective.token })
                .then((response) => {
                    this.objectives = response.data.objectives;
