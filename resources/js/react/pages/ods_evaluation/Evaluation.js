...
class Evaluation extends React.Component {
            ...
            return (
                <div className="row">
                    ...
                    <div className="col-lg-3 d-none d-lg-block">
                        ...
                        <br></br>
                        <small>
                            <strong>Encargado:</strong> {this.objective.manager}
                        </small>{" "}
                        <br></br>
                        <small>
        ...
        return (
            <div className="row">
                ...
                <div className="col-lg-3 d-none d-lg-block">
                    ...
                    ></p>
                    <small>
                        <strong>Año base:</strong> {this.objective.base_year}
                    </small>{" "}
                    <br></br>
                    <small>
                        <strong>Indicador:</strong> {this.objective.indicator}
                    </small>{" "}
                    <br></br>
                    <small>
                        <strong>Encargado:</strong> {this.objective.manager}
    ...
    componentDidMount() {
        axios
            .post("/ods/evaluate/get_evaluations", {
    ...
    save() {
        ...
        axios
            .post("/ods/evaluate/save", { data: rows, token: token })
            .then((response) => {
